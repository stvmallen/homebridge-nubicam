...
FFMPEG.prototype = {
    ...
    handleSnapshotRequest(request, callback) {
        ...
        let imageSource = this.snapshotSource !== undefined ? this.snapshotSource : this.getVideoSource();
    ...
    getVideoSource() {
        return this.videoSource !== undefined ? this.videoSource : this.feedSupplier().rtmp;
    },
